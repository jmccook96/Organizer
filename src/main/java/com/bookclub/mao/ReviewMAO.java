...
public class ReviewMAO implements IReviewAO {
    ...
    private void addTestData() {
        User user1 = new User("User1", "Password1", "Shromm", "shromm@qut.edu.au");
        User user2 = new User("User2", "Password2", "James", "james@qut.edu.au");
        User user3 = new User("User3", "Password3", "Bonnie", "bonnie@qut.edu.au");
